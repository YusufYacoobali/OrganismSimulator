...
public class SimulatorView extends JFrame
{
    ...
    private JLabel weatherLabel, hourLabel, dayLabel, stepLabel, population, infected;
    ...
    public SimulatorView(int height, int width)
    {
        ...
        JPanel infoPane = new JPanel(new BorderLayout());
            ...
            infoPane.add(hourLabel, BorderLayout.CENTER);
    ...
    public void showStatus(int step, Field field, int time, int day, String weather)
    {
        ...
        hourLabel.setText(HOUR_PREFIX + time);
